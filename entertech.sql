...
INSERT INTO `locations` (`id`, `name`, `match_discount`, `created_at`) VALUES
(1, 'Dhaka', 25, '2021-12-17 13:30:16'),
(2, 'Rajshahi', 10, '2021-12-17 13:30:16'),
(3, 'Chittagong', 30, '2021-12-17 13:30:16');
...
CREATE TABLE `orders` (
  ...
  `status` enum('submitted','in_transit','delivered') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'submitted'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
